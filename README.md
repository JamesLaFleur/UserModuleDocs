...
### Описание функционала модуля
 ...
 1. **Регистрация пользователя, отправка кода для подтверждения на номер телефона**
    ...
    *Входные данные:*
    ...
    | --- | --- | --- | --- |
    | firstname | string | Обязательный, мин. 2 символа | Имя пользователя |
    | phone | string | Обязательный | Телефон, русский |
    | email | string | - - | Email пользователя |
    | password | string | Минимум 8 символов | Пароль пользователя |
 ...
 3. **Подтверждение по номеру телефона**
    ...
    *Входные данные:* 
    ...
    - тело запроса - содержит номет телефона пользователя: 
